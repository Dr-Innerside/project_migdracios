    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_desc', models.CharField(max_length=50, verbose_name='카테고리 설명')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('commenter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='사용자')),
            ],
        ),
        migrations.AddField(
            model_name='article',
