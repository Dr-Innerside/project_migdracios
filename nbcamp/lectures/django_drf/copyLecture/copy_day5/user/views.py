...
from ai.permissions import RegistedMoreThanAWeekUser, IsAdminOrIsAuthenticatedReadOnly
...
class UserView(APIView):
    ...
    def get(self, request):
        ...
        return Response(UserSerializer(all_users, many=True).data, status=status.HTTP_200_OK) # 전체 유저를 대상
